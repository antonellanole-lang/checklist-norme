  ...
  architettura: {
    ...
    { title: "1. LOCALIZZAZIONE E PIANIFICAZIONE URBANISTICA", group: "DM18.12.75-Edilizia scolastica", items: [
      ...
      { title: "14. CONDIZIONI ACUSTICHE", group: "DM18.12.75-Edilizia scolastica", items: [
        ...
        { text: "Tempo di riverberazione nelle aule arredate entro i valori previsti (figg
      ...
      { title: "D.P.R. 503/1996 – ART. 6 – ATTRAVERSAMENTI PEDONALI", items: [
        ...
        { text: "Il fondo stradale in prossimità dell'attraversamento pedonale può essere differenziato mediante rugosità per segnalare la necessità di moderare la velocità.", ref: "D.P.R. 503/1996, 6.2" },
      ...
      { title: "D.P.R. 503/1996 – ART. 18 – RACCORDI CON LA NORMATIVA ANTINCENDIO", items: [
      ...
      { title: "L. 13/1989 – ART. 4 – IMMOBILI VINCOLATI – BELLEZZE NATURALI", items: [
      ...
      { title: "L. 13/1989 – ART. 5 – IMMOBILI VINCOLATI – INTERESSE ARTISTICO O STORICO", items: [
      ...
      { title: "L. 13/1989 – ART. 10 e 11 – PROCEDURA DI RICHIESTA E ASSEGNAZIONE DEL CONTRIBUTO", items: [
        ...
        { text: "In caso di fondi insufficienti: priorità alle domande di invalidi totali con difficoltà di deambulazione, poi ordine cronologico", ref: "L. 13/1989, Art. 10 c.4" },
